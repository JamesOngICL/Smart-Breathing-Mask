...
def read_temp_hum(sensor):
    ...
    si7021_READ_TEMPERATURE = sensor #Add the command to read temperature here
    ...
    print("displayin humidity", conv_temperature(temperature))
    return conv_humidity(temperature)
